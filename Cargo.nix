...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "git+https://github.com/stackabletech/operator-rs.git?tag=stackable-operator-0.106.1#stackable-telemetry@0.6.1" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "tracing-opentelemetry 0.32.1";
          }
          {
            name = "tracing-subscriber";
            packageId = "tracing-subscriber";
      ...
      "stackable-operator" = rec {
        ...
        dependencies = [
          ...
          {
            name = "stackable-telemetry";
            packageId = "git+https://github.com/stackabletech/operator-rs.git?tag=stackable-operator-0.106.1#stackable-telemetry@0.6.1";
            optional = true;
            features = [ "clap" ];
          }
          {
      ...
      "sys-mount" = rec {
        ...
        version = "3.1.0";
        edition = "2021";
        sha256 = "1ysbl6g1rjvmja50p7yrajq4zqlmmmkygp60az309sjn291zaqfk";
        libName = "sys_mount";
        authors = [
      ...
      "tracing-opentelemetry 0.32.1" = rec {
        crateName = "tracing-opentelemetry";
        version = "0.32.1";
        edition = "2021";
