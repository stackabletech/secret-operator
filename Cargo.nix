  ...
  internal = rec {
    ...
    crates = {
      ...
      "cross-krb5" = rec {
        ...
        version = "0.3.0";
        edition = "2021";
        sha256 = "0z2516nsva9p9663is5yrgn44lw58vcjk3bv1zpm6awqcaxv5gp1";
        authors = [
      ...
      "krb5" = rec {
        ...
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./rust/krb5; }
          else ./rust/krb5;
        authors = [
      ...
      "krb5-sys" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./rust/krb5-sys; }
          else ./rust/krb5-sys;
        authors = [
          "Stackable GmbH <info@stackable.tech>"
        ];
      ...
      "ldap3" = rec {
        ...
        version = "0.11.3";
        edition = "2021";
        sha256 = "007lwk9jyka2vgkfapq2mfjgbk3p6nb9nqbg69wqc30lmhpbbkkd";
        authors = [
          "Ivan Nejgebauer <inejge@gmail.com>"
        ];
        dependencies = [
      ...
      "libgssapi" = rec {
        ...
        version = "0.6.4";
        edition = "2018";
        sha256 = "0pqfm5hv5wfk4f33dkb3yl99f4piqj8p8rpa8qm29z5ygkvvgkwx";
        authors = [
          "Eric Stokes <letaris@gmail.com>"
        ];
        dependencies = [
      ...
      "libgssapi-sys" = rec {
        ...
        edition = "2018";
        links = "gssapi_krb5";
        sha256 = "1yybg12d5a6ihx4b50srw87wd351jgykc9pz846ji9isj8qxvp7g";
        authors = [
          "Eric Stokes <letaris@gmail.com>"
        ];
        buildDependencies = [
      ...
      "regex" = rec {
        ...
        dependencies = [
          ...
          {
            name = "regex-automata";
            packageId = "regex-automata 0.4.1";
            usesDefaultFeatures = false;
            features = [ "alloc" "syntax" "meta" "nfa-pikevm" ];
          }
          {
            name = "regex-syntax";
            packageId = "regex-syntax 0.8.1";
            usesDefaultFeatures = false;
          }
        ];
        features = {
      ...
      "stackable-krb5-provision-keytab" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./rust/krb5-provision-keytab; }
          else ./rust/krb5-provision-keytab;
        authors = [
          "Stackable GmbH <info@stackable.tech>"
        ];
        dependencies = [
      ...
      "stackable-secret-operator-crd-utils" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./rust/crd-utils; }
          else ./rust/crd-utils;
        authors = [
          "Stackable GmbH <info@stackable.tech>"
        ];
      ...
      "sys-mount" = rec {
        ...
        version = "2.1.0";
        edition = "2021";
        sha256 = "1ga2c6bb3zj4l5xcahr9fy7xbd9jsl2a12aic9j27ynigqwqnsxb";
        authors = [
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "ntsecapi" "processenv" "ws2ipdef" "ws2tcpip" "wtypesbase" ];
      };
