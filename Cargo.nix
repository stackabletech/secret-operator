    ...
    crates = {
      ...
      "cert-tools" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "stackable-telemetry 0.6.1";
            features = [ "clap" ];
          }
          {
            name = "tracing";
      ...
      "k8s-version" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          sha256 = "0xw8nz7im6b2k9p87gggcqjn6lpl9y1cv1zh58fx9bjblm9vcr5p";
        };
        libName = "k8s_version";
        authors = [
      ...
      "opentelemetry-appender-tracing 0.32.0" = rec {
        crateName = "opentelemetry-appender-tracing";
        version = "0.32.0";
        edition = "2021";
        ...
        dependencies = [
          {
            name = "opentelemetry";
            packageId = "opentelemetry 0.32.0";
            usesDefaultFeatures = false;
            features = [ "logs" ];
          }
          {
      ...
      "opentelemetry-otlp 0.32.0" = rec {
        ...
        dependencies = [
          ...
          {
            name = "opentelemetry-http";
            packageId = "opentelemetry-http 0.32.0";
            optional = true;
            usesDefaultFeatures = false;
          }
          {
            name = "opentelemetry-proto";
            packageId = "opentelemetry-proto 0.32.0";
            usesDefaultFeatures = false;
          }
          {
            name = "opentelemetry_sdk";
            packageId = "opentelemetry_sdk 0.32.1";
            usesDefaultFeatures = false;
          }
          {
            name = "prost";
            packageId = "prost 0.14.4";
            optional = true;
          }
          {
            name = "reqwest";
      ...
      "opentelemetry-proto 0.32.0" = rec {
        crateName = "opentelemetry-proto";
        version = "0.32.0";
        edition = "2021";
      ...
      "opentelemetry-semantic-conventions 0.32.1" = rec {
        crateName = "opentelemetry-semantic-conventions";
        version = "0.32.1";
        edition = "2021";
      ...
      "stackable-operator" = rec {
        ...
        dependencies = [
          ...
          {
            name = "stackable-telemetry";
            packageId = "stackable-telemetry 0.6.5";
            features = [ "clap" ];
          }
          {
        ...
        resolvedDefaultFeatures = [ "crds" "default" "time" "webhook" ];
      };
      ...
      "stackable-telemetry 0.6.5" = rec {
        ...
        dependencies = [
          ...
          {
            name = "opentelemetry-appender-tracing";
            packageId = "opentelemetry-appender-tracing 0.32.0";
          }
          {
            name = "opentelemetry-otlp";
            packageId = "opentelemetry-otlp 0.32.0";
            features = [ "grpc-tonic" "gzip-tonic" "logs" ];
          }
          {
            name = "opentelemetry-semantic-conventions";
            packageId = "opentelemetry-semantic-conventions 0.32.1";
          }
          {
            name = "opentelemetry_sdk";
            packageId = "opentelemetry_sdk 0.32.1";
          ...
          {
            name = "tracing-opentelemetry";
            packageId = "tracing-opentelemetry 0.33.0";
          }
          {
            name = "tracing-subscriber";
            packageId = "tracing-subscriber";
      ...
      "tracing-opentelemetry 0.33.0" = rec {
        crateName = "tracing-opentelemetry";
        version = "0.33.0";
        edition = "2021";
