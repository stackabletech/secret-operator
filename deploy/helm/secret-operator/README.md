...
- `oci://quay.io/stackable/sdp-charts/secret-operator`
...
See the [documentation](https://docs.stackable.tech/home/stable/secret-operator/) for the full picture.

## Custom resources

This operator installs and manages its own CustomResourceDefinitions, so they are not part of this chart.
The resources it reconciles, and the configuration they accept, are described in the [documentation](https://docs.stackable.tech/home/stable/secret-operator/).
## Links

- [Documentation](https://docs.stackable.tech/home/stable/secret-operator/)
- [Stackable Hub](https://hub.stackable.tech/)
- [Source](https://github.com/stackabletech/secret-operator)
- [Report an issue](https://github.com/stackabletech/secret-operator/issues)
- [Stackable Data Platform](https://stackable.tech/)

## License

[Open Software License version 3.0](https://github.com/stackabletech/secret-operator/blob/main/LICENSE)
